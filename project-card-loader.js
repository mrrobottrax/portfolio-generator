...
function populateProjects() {
	const collabCards = [
		new ProjectCard(
			...
			"project-page.html?project-id=beat-em-up",
		...
		new ProjectCard(
			...
			"project-page.html?project-id=snow",
		...
		new ProjectCard(
			...
			"project-page.html?project-id=obscurum",
		...
		new ProjectCard(
			...
			"project-page.html?project-id=news",
		...
		new ProjectCard(
			...
			"project-page.html?project-id=o2",
	...
	const soloCards = [
		new ProjectCard(
			...
			"project-page.html?project-id=webgl",
			"projects/web3d/images/thumbnail.png",
		),
		new ProjectCard(
			"Raytracer",
			"A simple realtime raytracing engine.",
			"project-page.html?project-id=raytrace",
